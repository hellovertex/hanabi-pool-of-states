...
#
#   trainloader = MapStylePoolOfStatesFromDatabase(from_db_path=from_db_path).get_eagerly(size=using_num_states,
...
#
#
# def run_train_eval_with_ray(env_config, using_num_states, db_path, name, scheduler, search_space, metric, mode,
