...
#   n_states_for_evaluation, hyperparam_grid, log_interval, eval_interval, max_epochs, ckpt_interval, max_train_iters
...
#     print(f'-------------------------------------------------------------')
#     print(f'Training lr = {lr}, net = {str(self.net)}')
#     print(f'-------------------------------------------------------------')
...
#                      ckpt_dir=ckpt_dir).train_eval(lr) for net in nets]
#
#
# def main():
