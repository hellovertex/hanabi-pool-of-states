...
class InternalProbabilistic(Agent):
  ...
  def __init__(self, config, *args, **kwargs):
    ...
    self.rules = [Ruleset.play_probably_safe_factory(0.6,True),Ruleset.osawa_discard,Ruleset.tell_playable_card,Ruleset.tell_randomly,Ruleset.discard_randomly]
